...
root_dir = '/mnt/j/ArmK/DICOM/' 
#root_dir = 'G:\\ArmK\\DICOM\\'
arms_to_check = ['AK'] #'ACE' 'AG''AH',
...
def main():
    skip = True # Use this as a flag to quickly skip all directories up to end_skip 
    end_skip = '/mnt/j/ArmK/DICOM/88092 [STAMPEDE]' #! THIS NEEDS TO BE UPDATED
